...
model = EEGUNetDeep(ch=66)
model.load_state_dict(torch.load("eeg_model/ddpm_model.pth", map_location=torch.device("cpu")))

# STEP 3: Sample synthetic EEG
synthetic = sample_ddpm(model, shape=(10, 66, 750))  # generate 10 samples
np.save("eeg_model/synthetic_eeg.npy", synthetic)
